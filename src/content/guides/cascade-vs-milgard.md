...
faq:
  ...
  - question: Do Cascade and Milgard use the same glass?
    answer: No. Each brand specs its own glass package and Low-E coating, and the numbers differ by product line within each brand too. Ask for the U-factor and SHGC on the specific unit quoted, not the brand name alone.
...
## Glass and U-factor: read the number, not the name
