...
faq:
  ...
  - question: Is vinyl a bad choice in a wet climate?
    answer: No. Vinyl doesn't rot, rust, or need paint, and it's held up fine in the Pacific Northwest for decades on standard-size openings. The tradeoffs are about frame stiffness and thermal movement on larger units, not moisture resistance.
  - question: Can vinyl windows be painted to change color later?
    answer: Not well. Vinyl's surface isn't built to hold paint long-term the way fiberglass or wood can, so the color you order is close to the color you keep. Fiberglass takes paint if you want to change the exterior color down the road.
