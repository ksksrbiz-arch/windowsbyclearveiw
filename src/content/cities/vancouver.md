...
faq:
  - question: Which Vancouver neighborhoods do you actually cover?
    answer: All of them. Hazel Dell, Salmon Creek, Felida, Orchards, Cascade Park, downtown, Fisher's Landing — Vancouver is home base, so the drive is short no matter which part of the city you're in.
  - question: My house is older. Does that rule out a simple window swap?
    answer: It depends on the frame, not the age. If the existing frame is still square and solid, an insert goes in without touching the rough opening. If it's rotted, out of square, or the old frame is metal, it comes out to the rough opening instead. See full-frame vs. insert for the actual dividing line.
  - question: Do you set windows in new Vancouver subdivisions?
